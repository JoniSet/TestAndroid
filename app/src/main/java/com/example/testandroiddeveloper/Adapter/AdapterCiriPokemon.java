...
public class AdapterCiriPokemon extends RecyclerView.Adapter<AdapterCiriPokemon.ViewHolder> {
    private Context context;
    private ArrayList<DataCiriPokemon> dataPokemon;
    public static ClickCiri clickCiri;

    public AdapterCiriPokemon(Context context, ArrayList<DataCiriPokemon> dataPokemon) {
    ...
    @NonNull
    @Override
    public AdapterCiriPokemon.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_ciri, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterCiriPokemon.ViewHolder holder, int position) {
    ...
    public void onClickListener(ClickCiri clickCiri){
        AdapterCiriPokemon.clickCiri    = clickCiri;
    }
}
